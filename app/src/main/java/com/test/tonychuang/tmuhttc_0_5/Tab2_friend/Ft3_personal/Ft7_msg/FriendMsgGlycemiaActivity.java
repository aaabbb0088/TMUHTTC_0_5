...
public class FriendMsgGlycemiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_msg_glycemia);
    ...
    private void initBar(String nickName) {
        myInitReturnBar = new MyInitReturnBar(this, nickName + " 的本日血糖留言板", 0);
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_UP:
                        if (!moveFlag) {
                            box.hideLayout();
                            box.hideKeyboard(FriendMsgGlycemiaActivity.this);
...
//        File faceList = FileUtils.getSaveFolder("chat");
    ...
    private void initData() {
        ...
        DataBase mainDB = LiteOrm.newSingleInstance(FriendMsgGlycemiaActivity.this, signInShrPref.getAID());
            ...
            new AsyncTask<String, Void, Boolean>() {
                ...
                protected void onPostExecute(Boolean aBoolean) {
                    ...
                    if (aBoolean) {
                        ...
                        Toast.makeText(FriendMsgGlycemiaActivity.this, "網路不穩，請稍後留言", Toast.LENGTH_SHORT).show();
                    }
                }
