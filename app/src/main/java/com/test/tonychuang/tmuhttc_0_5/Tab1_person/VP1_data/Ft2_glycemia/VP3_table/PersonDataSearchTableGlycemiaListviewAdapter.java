 ...
 */
public class PersonDataSearchTableGlycemiaListviewAdapter extends BaseAdapter {
    ...
    public PersonDataSearchTableGlycemiaListviewAdapter(Context ctxt, ArrayList<GlyDataRow> Table, String dataFlag) {
