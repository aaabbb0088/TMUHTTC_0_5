...
public class PersonMsgPressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_msg_press);
    ...
    private void initBar() {
        myInitReturnBar = new MyInitReturnBar(this, "我的今日血壓留言板", 0);
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_UP:
                        if (!moveFlag) {
                            box.hideLayout();
                            box.hideKeyboard(PersonMsgPressActivity.this);
            ...
            new AsyncTask<String, Void, Boolean>() {
                ...
                protected void onPostExecute(Boolean aBoolean) {
                    ...
                    if (aBoolean) {
                        ...
                        DataBase mainDB = LiteOrm.newSingleInstance(PersonMsgPressActivity.this, signInShrPref.getAID());
                        ...
                        Toast.makeText(PersonMsgPressActivity.this, "網路不穩，請稍後留言", Toast.LENGTH_SHORT).show();
                    }
                }
