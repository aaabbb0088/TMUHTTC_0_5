 ...
 */
public class FriendDataSearchTablePressListviewAdapter extends BaseAdapter {
    ...
    public FriendDataSearchTablePressListviewAdapter(Context ctxt, ArrayList<PreDataRow> pressTable, String dataFlag, String friSid, String aid) {
