 ...
 */
public class FriendDataSearchTablePressItemNameListviewAdapter extends BaseAdapter {
    private LayoutInflater myInflater;
    private String dataFlag;

    public FriendDataSearchTablePressItemNameListviewAdapter(Context ctxt, String dataFlag) {
