 ...
 */
public class FriendServiceMedicineListviewAdapter extends BaseAdapter {
    private LayoutInflater myInflater;
    ArrayList<SMedRow> medicineTable = null;

    public FriendServiceMedicineListviewAdapter(Context ctxt, ArrayList<SMedRow> medicineTable) {
