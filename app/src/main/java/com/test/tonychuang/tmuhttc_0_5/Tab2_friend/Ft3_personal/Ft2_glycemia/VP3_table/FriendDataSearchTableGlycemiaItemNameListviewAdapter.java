 ...
 */
public class FriendDataSearchTableGlycemiaItemNameListviewAdapter extends BaseAdapter {
    private LayoutInflater myInflater;

    public FriendDataSearchTableGlycemiaItemNameListviewAdapter(Context ctxt) {
