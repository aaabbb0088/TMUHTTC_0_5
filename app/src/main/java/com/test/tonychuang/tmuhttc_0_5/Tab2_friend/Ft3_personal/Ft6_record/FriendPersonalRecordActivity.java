package com.test.tonychuang.tmuhttc_0_5.Tab2_friend.Ft3_personal.Ft6_record;
...
import com.test.tonychuang.tmuhttc_0_5.Tab1_person.VP2_service.Ft4_record.PersonServiceRecordItemNameListviewAdapter;
import com.test.tonychuang.tmuhttc_0_5.Tab1_person.VP2_service.Ft4_record.PersonServiceRecordListviewAdapter;
...
/**
 * 調用 PersonServiceRecordActivity 的 ListViewAdapter
 */
/**
 *
 */

public class FriendPersonalRecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_personal_record);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.startDateTv:
                myPopuTimeWheel = new MyPopuTimeWheel(FriendPersonalRecordActivity.this, startDateTv, endDateTv, 2, 1);
                searchBtn.setEnabled(true);
                break;
            case R.id.endDateTv:
                myPopuTimeWheel = new MyPopuTimeWheel(FriendPersonalRecordActivity.this, endDateTv, startDateTv, 2, 1);
                searchBtn.setEnabled(true);
                break;
            case R.id.searchBtn:
    ...
    private void initBar(String nickName) {
        myInitReturnBar = new MyInitReturnBar(this, nickName + "的服務歷程", 0);
    }
