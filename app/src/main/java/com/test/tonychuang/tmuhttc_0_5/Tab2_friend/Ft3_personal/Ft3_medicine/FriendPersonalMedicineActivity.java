...
public class FriendPersonalMedicineActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initBar(String nickName) {
        myInitReturnBar = new MyInitReturnBar(this, nickName + "的用藥紀錄", 0);
    }
    ...
    private void showResult(ArrayList<SMedRow> sMedRows) {
        ...
        if (dataSize == 0) {
            ...
            listViewItemName.setAdapter(new FriendServiceMedicineItemNameListviewAdapter(FriendPersonalMedicineActivity.this));
        } else {
            loadStatusText.setVisibility(View.GONE);
            listViewData.setVisibility(View.VISIBLE);
            listViewItemName.setAdapter(new FriendServiceMedicineItemNameListviewAdapter(FriendPersonalMedicineActivity.this));
            listViewData.setAdapter(new FriendServiceMedicineListviewAdapter(FriendPersonalMedicineActivity.this, sMedRows));
        }
    }
