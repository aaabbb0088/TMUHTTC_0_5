...
import com.test.tonychuang.timescroller.RulerScrollView.ScrollType;
import com.test.tonychuang.timescroller.RulerScrollView.ScrollViewListener;
...
public class Ruler extends FrameLayout {
	...
	private void initParentContainer() {
		...
		LayoutParams scrollerParams = new LayoutParams(
				-1, -2);
		...
		rootContainer.setLayoutParams(new LayoutParams(-1,
				-2));
		...
		LayoutParams params3 = new LayoutParams(-1,
				paramsTop.topMargin);
		...
		LayoutParams paramsMark = new LayoutParams(-2,
				-1);
